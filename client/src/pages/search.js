...
class Search extends Component {
  ...
  handleSearchInput = event => {
    ...
    console.log("Handle search imput" + event.target.value);
  };
  ...
  clickAddBtn = (event) => {
    ...
    this.state.books.map((book, i) => {
      ...
      console.log("test 1" + this.title, this.authors, this.description, this.synopsis, this.image);
    ...
    console.log("test2" + this.title, this.authors, this.description, this.synopsis, this.image);
